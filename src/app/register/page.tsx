        ...
        <div className="relative rounded-3xl border border-white/10 bg-[#0a0a0a]/95 p-8 shadow-2xl backdrop-blur-xl sm:p-10">
          ...
          <form className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-white/10 bg-white/[0.03] px-4 py-3 pr-14 text-sm text-white outline-none transition placeholder:text-white/20 focus:border-rose-400/40 focus:bg-rose-500/[0.03] focus:shadow-[0_0_20px_rgba(244,63,94,0.06)]"
                />
            ...
            <div className="flex items-start gap-2">
              ...
              >
                I agree to the{" "}
                <span className="cursor-pointer text-rose-400 hover:text-rose-300">
                  Terms of Service
                </span>{" "}
                and{" "}
                <span className="cursor-pointer text-rose-400 hover:text-rose-300">
            ...
            <button
              type="submit"
              className="w-full rounded-xl bg-rose-500 py-3 text-sm font-semibold text-white shadow-[0_0_25px_rgba(244,63,94,0.18)] transition hover:bg-rose-400 hover:shadow-[0_0_35px_rgba(244,63,94,0.28)] active:scale-[0.99]"
            >
              Create account
            </button>
